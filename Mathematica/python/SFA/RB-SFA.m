...
simpleDipole= makeDipoleList[VectorPotential->Function[t,{F/w Sin[w*t],0,0}],
	FieldParameters->{F->0.05,w->0.057},CarrierFrequency->0.057,Target->"Xenon"];


simpleDipole


ListPlot[Transpose[{timeAxis[CarrierFrequency->0.057],Re[simpleDipole[[All,1]]]}],AxesLabel->{"t(s)","d"}]


spectrumPlotter[getSpectrum[Most[simpleDipole]],ImageSize->400]
